      ...
      <div className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-6 md:p-8 flex-1 flex flex-col justify-between">
              <div>
                <div className="flex items-center gap-3 mb-6">
              ...
              <div className="pt-6 mt-6 border-t border-gray-100 flex items-center justify-center text-xs text-gray-400 text-center">
                Sistem Informasi Keuangan & Operasional Yayasan Rumah Etnik Papua
              </div>
            </div>
          </div>
        </div>
